        ...
        <section className="relative w-full">
            ...
            */}
            ...
            <div className="container mx-auto px-4 md:px-8 relative z-10 pt-20 pb-10">
                <div className="flex flex-col md:flex-row items-center justify-between min-h-[600px] mb-20">
                    {/* Left Content */}
                    <div className="w-full md:w-1/3 text-left self-start pt-10">
                    ...
                    {/* Central Diagram */}
                    <div className="w-full md:w-2/3 h-[600px] relative flex items-center justify-center">
                        <div className="relative z-20 bg-white/90 backdrop-blur-md w-72 h-72 rounded-full flex flex-col items-center justify-center text-center shadow-[0_0_40px_rgba(255,255,255,0.6)] border border-white/50">
                            <p className="text-gray-500 text-base font-medium">At <span className="text-[#D4A056] font-bold">Dinaaz</span>, we start with</p>
                            <h3 className="text-2xl font-bold text-[#3EBCB3] leading-tight my-2">
                                medical understanding,
                            </h3>
                            <p className="text-[#D4A056] font-serif italic text-xl font-bold">not assumptions.</p>
                        ...
                        <div className="absolute top-[10%] right-[5%] md:right-[10%] flex flex-col items-center w-40 text-center transform hover:scale-105 transition-transform duration-300">
                            <div className="w-36 h-36 rounded-full overflow-hidden border-4 border-white shadow-lg mb-3">
                            ...
                            <div className="absolute bottom-8 right-2 bg-white rounded-full p-1 shadow text-gray-400 text-xs">🔍</div>
                        </div>

                        <div className="absolute bottom-[20%] right-[10%] md:right-[15%] flex flex-col items-center w-40 text-center transform hover:scale-105 transition-transform duration-300">
                            <div className="w-36 h-36 rounded-full overflow-hidden border-4 border-white shadow-lg mb-3">
                        ...
                        <div className="absolute bottom-[20%] left-[5%] md:left-[15%] flex flex-col items-center w-40 text-center transform hover:scale-105 transition-transform duration-300">
                            <div className="w-36 h-36 rounded-full overflow-hidden border-4 border-white shadow-lg mb-3">
